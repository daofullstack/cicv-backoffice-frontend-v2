<template>
  <div>
    <DataTable :table="table" ref="deliveryManTable" />
  </div>
</template>
          ...
          topRightButtons: [
            {
              ...
              action: () => {
                this.$router.push({ name: "deliveryManAdd" });
              },
            },
            {
        ...
        actions: [
          {
            ...
            isVisible: (data) =>
              ...
              !this.isSelf(data),
            getRecord: (data) => {
              this.$router.push({ name: "deliveryManEdit", params: { id: data._id } });
            },
          },
          {
            text: "Delete Data",
            ...
            getRecord: async (data) => {
              ...
              if (archived) this.$refs.deliveryManTable.refreshTable();
            },
          },
          {
            text: "Activate Data",
            ...
            getRecord: async (data) => {
              ...
              if (activated) this.$refs.deliveryManTable.refreshTable();
            },
          },
        ],
      },
