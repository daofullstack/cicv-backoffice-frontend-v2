          ...
          topRightButtons: [
            {
              ...
              action: () => {
                this.$router.push({ name: "usersAdd2" });
              },
            },
            {
        ...
        actions: [
          {
            ...
            isVisible: (data) =>
              ...
              !this.isSelf(data),
            getRecord: (data) => {
              this.$router.push({ name: "usersEdit2", params: { id: data._id } });
            },
          },
          {
            text: "Delete Data",
            ...
            getRecord: async (data) => {
              ...
              if (archived) this.$refs.usersTable2.refreshTable();
            },
          },
          {
            text: "Activate Data",
            ...
            getRecord: async (data) => {
              ...
              if (activated) this.$refs.usersTable2.refreshTable();
            },
          },
        ],
      },
